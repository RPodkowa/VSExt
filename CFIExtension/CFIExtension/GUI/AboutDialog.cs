...
namespace CFIExtension
{
    partial class AboutDialog : Form
    {
        ...
        private string GetDescription()
        {
            ...
            desc.Add("   2.1.1 Copy Release");
            desc.Add("  2.2. ToolbarRunGroup");
            desc.Add("   2.2.1 Run Vendo in normal mode");
            desc.Add("   2.2.2 Run Vendo in reader mode");
            desc.Add("  2.3. ToolbarCopyRunGroup");
            desc.Add("   2.3.1 Copy Release and run Vendo in normal mode");
            desc.Add("   2.3.2 Copy Release and run Vendo in reader mode");
            desc.Add("  2.4. ToolbarUpdateAmagDataGroup");
            desc.Add("   2.4.1 Update Amag.Data");
            desc.Add("  2.5. ToolbarUpdateEnumsGroup");
            desc.Add("   2.5.1 Update Enums");
            desc.Add("  2.6. ToolbarOpenFileGroup");
            desc.Add("   2.6.1 Open macros.xml");
